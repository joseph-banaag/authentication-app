...
export default function Footer() {
    return (
        <div className="flex flex-1 flex-col justify-center items-center p-[1em] bg-violet-950 gap-1.5">
            ...
            <p className="text-xs text-slate-300 text-center ">For the illustration, I am using the online illustration by <Link href="https://storyset.com/online" className="text-violet-500 underline underline-offset-4 cursor-pointer text-xs font-semibold">Storyset</Link></p>
        </div>
    )
}