      ...
      >
        <div className="flex flex-col gap-2 ">
          <Card className="cardContainer " shadow="md">
            <div className="cardHeadingContainer">
              ...
              <h1 className="textHeadingResponsive">Security</h1>
            </div>
          </Card>

          <div className="cardContentWrapper ">
            <div className="flex flex-col gap-1">
              <h1 className="textHeading2Responsive">
                Last Update on your account
              </h1>
              ...
              <div className=" w-[95%] mx-auto">
                {!isChanged ? (
                  <h1 className="textBaseColor">
                    The last changes on your account happened on:{" "}
                    <b>{updatedOn}</b>
                  </h1>
                ) : (
                  <h1 className="textBaseColor">
                    No changes on your account yet.
                  </h1>
                )}
              </div>

              <div className="flex flex-col gap-1">
                <p className="text-foreground/70 text-sm font-normal drop-shadow-md">
                  Go to your profile to keep your account updated.
                </p>
                <Link
                  href="/profile"
        ...
        <div className="flex flex-col gap-2 pt-10">
          <div className="cardContentWrapper">
            ...
            <div className="flex flex-col gap-2">
              <div className="smallTextColor">
                <b className="text-red-500">WARNING:</b> The process of deleting
                your account is irreversible. Proceed with cautions.
              </div>
              <Button
