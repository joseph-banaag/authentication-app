      ...
      >
        <div className="relative flex flex-col justify-center items-center min-h-screen delay-3000 z-10 gap-5 mt-5">
          ...
          <div className="py-2 px-5 flex justify-center items-center mt-2">
            <h1 className="sm:text-sm text-xs text-end mr-1 drop-shadow-md">Already have an account? Click <Link href="/sign-in" className="text-[#FB542B] font-semibold sm:text-sm text-xs cursor-pointer">Sign In</Link></h1>
          </div>
        </div>
      </motion.div>
    </main>
